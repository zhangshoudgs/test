...
package com.zs.book.view.FlowingDrawer;
...
public abstract class ElasticDrawer extends ViewGroup {
    ...
    protected void initDrawer(Context context, AttributeSet attrs) {
        ...
        mContentContainer = new BuildLayerFrameLayout(context);
            ...
            case Position.RIGHT:
                if (!mMenuVisible) {
                    canScroll = canChildScrollHorizontally(mContentContainer, false, dx,
                            x - getLeft(mContentContainer), y - getTop(mContentContainer));
                } else {
                    canScroll = canChildScrollHorizontally(mMenuContainer, false, dx,
                            x - getLeft(mMenuContainer), y - getTop(mContentContainer));
                }
                break;
        }
    ...
    @SuppressLint("NewApi")
    protected int getLeft(View v) {
        return (int) (v.getLeft() + v.getTranslationX());
    }

    @SuppressLint("NewApi")
    protected int getTop(View v) {
        return (int) (v.getTop() + v.getTranslationY());
    }

    @SuppressLint("NewApi")
    protected int getRight(View v) {
        return (int) (v.getRight() + v.getTranslationX());
    }

    @SuppressLint("NewApi")
    protected int getLayoutDirection(View v) {
